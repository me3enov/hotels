 ...
 * Улучшено!
 * Можно задать колличество вопросов/утвердительных ответов, редактируя answersForWhoSpeaksTheTruth
 */
 ...
 * Улучшено!
 * Можно задать колличество запускаемых предметов (попыток), редактируя itemsForTry.
 */
 ...
 * Улучшено!
 * Можно задать колличество людей, редактируя usersForPies
 */
